<footer
    ...
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        <a href="https://vincentius-hadianta-wibawa.fly.dev/" class="hover:underline"
            target="_blank">vincentius-hadianta-wibawa.fly.dev</a>
    </p>

    <div class="flex justify-center items-center space-x-1">
        <a href="https://github.com/errorsolver" data-tooltip-target="tooltip-github"
