<x-layout>
    ...
    <div class="py-4 mx-auto max-w-screen-xl lg:py-4">
        @empty($posts) {{-- Check if notEmpty --}}
            <div>
                <p class="font-semibold text-xl my-4 center">
                    Article Not Found!
                </p>
                    ...
                    p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex justify-between items-center mb-5 text-gray-500">
                            <a href="/posts?category={{ $post->category->slug }}"
                                ...
                                class="text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded hover:underline">
                        ...
                        <h2 class="mb-2 text-2xl font-bold tracking-tight capitalize text-gray-900 dark:text-white">
                            {{ $post->title }}
                        </h2>
                        <p class="mb-5 font-light text-justify text-gray-500 dark:text-gray-400">
                            {{ Str::limit($post->body, 120) }}</p>
